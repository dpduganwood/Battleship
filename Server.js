...
app.get('/join', function (req, res) {
    ...
    var game;
    var tempKey;
    if(req.query.key < 0 || games[req.query.key] == null || games[req.query.key].player2 != games[req.query.key].player1 || (req.query.key == "single" && (req.query.eOrH != "easy" || req.query.eOrH != "hard"))) {
